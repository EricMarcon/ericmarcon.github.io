...
# Nombre minimal de copuplications pour figuer sur le graphique
copublication_min <- 2
...
ggraph(g, layout = "auto") +
  ...
  labs(
    title = paste("Coauthorship Network of", author_focus),
    caption = paste(
...
h Index: `r AuthorID %>% get_profile %>% pluck("h_index")`.
