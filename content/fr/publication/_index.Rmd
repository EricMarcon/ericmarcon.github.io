...
Library(c("bib2df", "scholar", "tidyverse", "ggraph", "igraph"))
```
...
ggraph(g, layout = "auto") +
  ...
  labs(
    title = "Réseau de co-autorat",
    caption = paste(
      "Coauteurs avec au moins", 
      copublication_min, 
      "co-publications")
  ) +
...
Indice h: `r AuthorID %>% get_profile() %>% pluck("h_index")` ([Google Scholar](`r paste0("https://scholar.google.com/citations?user=", AuthorID)`)).
